...
function App() {
  ...
  const handleSendMessage = () => {
    if (newMessage.trim() && user) {
      const messageData = {
        ...
        message: newMessage.trim() // can be text + emojis
      };
      ...
      <div className="login-container">
        <div className="login-card">
          ...
          <div className="form-container">
            ...
            <button onClick={handleSubmit} disabled={loading} className={`form-button ${loading ? 'loading' : ''}`}>
  ...
  return (
    <div className="chat-container">
      ...
      {/* Message Input */}
      <div className="input-container" onClick={() => setShowEmoji(!showEmoji)}>
